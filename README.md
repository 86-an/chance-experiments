...
## 📝 概要
**Chance Experiments**は、ガチャ・パチンコ・株式投資の確率シミュレーションを体験できるWebサイトです。統計学や確率論の実践的な学習ツールとして、また娯楽・投資の参考データとしてご活用いただけます。
...
3. **意思決定支援**: ガチャ・パチンコの期待値・収支分析、投資戦略の比較
...
- **柔軟な設定**:
  - 初期資金のみ or 積立投資
  - 固定リターン or モンテカルロ（ランダム）
  - NISA口座 or 課税口座
- **プリセット機能**:
  - S&P500（期待7%、ボラティリティ18%、配当1.5%）
  - 国内安定株（期待4.5%、ボラティリティ12%、配当2.5%）
  - 自由設定モード
- **詳細な統計分析**:
  - CAGR（年平均成長率）
  - 最大ドローダウン（最大下落率）
...
**株式投資**:
1. **モンテカルロシミュレーション**: ランダムな年次リターンで現実的な変動を再現
2. **複利vs単利の比較**: 再投資・ホールド戦略の違いを可視化
3. **税金・手数料の考慮**: NISA口座と課税口座の違いを明示
4. **インフレ調整**: 名目資産と実質資産の両方を表示
...
- [ ] アニメーション機能（ガチャ演出）
- [ ] 株式投資：複数銘柄ポートフォリオシミュレーション
- [ ] 株式投資：リバランス戦略の追加
- [ ] 株式投資：暴落シナリオのシミュレーション
